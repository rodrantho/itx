...
import { Menu, X, Calendar, Video } from 'lucide-react';
...
const Navbar = () => {
  ...
  const contactOptions = [
    { 
      ...
      action: () => window.open("https://wa.me/+598123456789", "_blank")
    },
    { 
      label: "Calendario",
    ...
    { 
      ...
      action: () => window.open("https://meet.google.com/your-meet-link", "_blank")
    }
  ];
